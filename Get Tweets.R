...
save(sanders_tweets,file=paste0("RawTweets/sanders_",dateStart,".Rda"))
...
save(biden_tweets,file=paste0("RawTweets/biden_",dateStart,".Rda"))
...
#save(warren_tweets,file=paste0("RawTweets/warren_",dateStart,".Rda"))
...
#save(buttigieg_tweets,file=paste0("RawTweets/buttigieg_",dateStart,".Rda"))
...
#save(klobuchar_tweets,file=paste0("RawTweets/klobuchar_",dateStart,".Rda"))
...
#save(bloomberg_tweets,file=paste0("RawTweets/bloomberg_",dateStart,".Rda"))
...
#save(steyer_tweets,file=paste0("RawTweets/steyer_",dateStart,".Rda"))
...
#save(yang_tweets,file=paste0("RawTweets/yang_",dateStart,".Rda"))
